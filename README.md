...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-29 22:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/02fcc75a-af7e-4449-b622-c5abbf4f0042.git
$ cd 02fcc75a-af7e-4449-b622-c5abbf4f0042
```
